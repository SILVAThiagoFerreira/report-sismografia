...
window.SISMO_CONFIG = {
  ...
  report_layout: {
    ...
    card_radius: 3.0,
    card_border_width: 0.55,
    section_header_height: 20.0,
    section_rule_width: 0.85,
    section_accent_width: 26.0,
    chart_header_height: 20.0,
    point_header_height: 17.0,
    chart_to_points_gap: 16.0,
    charts_top_limit: 484.0,
    footer_height: 30.0,
    footer_accent_height: 1.5,
    footer_side_padding: 28.0,
    status_badge_width: 100.0,
    status_badge_height: 16.0,
    status_badge_radius: 3.0,
  },
  report_text: {
  ...
  branding: {
    ...
    palette: {
      ...
      status_conforme_bg: "#EAF7D5",
      status_conforme_text: "#3F7600",
      status_verificar_bg: "#FDE8E7",
      status_verificar_text: "#A4232B",
      status_ausente_bg: "#F2F3F5",
      status_ausente_text: "#667085",
    },
  },
};
